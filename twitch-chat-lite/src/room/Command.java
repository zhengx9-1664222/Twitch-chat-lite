...
public class Command {
    ...
    public static CommandResponseCode channels(Room room, String channel, String instigator) {
        if (!channel.equals(ROOM_OVERRIDE) || !room.hasChannels()) {
            return CommandResponseCode.FAILURE;
        } else {
